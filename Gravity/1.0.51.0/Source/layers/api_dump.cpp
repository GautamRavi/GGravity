...
inline void dump_vkDebugMarkerSetObjectTagEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDebugMarkerObjectTagInfoEXT* pTagInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkDebugMarkerSetObjectNameEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDebugMarkerObjectNameInfoEXT* pNameInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkGetMemoryWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetMemoryWin32HandleKHX(dump_inst, result, device, memory, handleType, pHandle);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetMemoryWin32HandleKHX(dump_inst, result, device, memory, handleType, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
inline void dump_vkGetMemoryWin32HandlePropertiesKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHX* pMemoryWin32HandleProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetMemoryWin32HandlePropertiesKHX(dump_inst, result, device, handleType, handle, pMemoryWin32HandleProperties);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetMemoryWin32HandlePropertiesKHX(dump_inst, result, device, handleType, handle, pMemoryWin32HandleProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int* pFd)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetMemoryFdKHX(dump_inst, result, device, memory, handleType, pFd);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetMemoryFdKHX(dump_inst, result, device, memory, handleType, pFd);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryFdPropertiesKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int fd, VkMemoryFdPropertiesKHX* pMemoryFdProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetMemoryFdPropertiesKHX(dump_inst, result, device, handleType, fd, pMemoryFdProperties);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetMemoryFdPropertiesKHX(dump_inst, result, device, handleType, fd, pMemoryFdProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#if defined(VK_USE_PLATFORM_WIN32_KHX)
inline void dump_vkImportSemaphoreWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreWin32HandleInfoKHX* pImportSemaphoreWin32HandleInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkImportSemaphoreWin32HandleKHX(dump_inst, result, device, pImportSemaphoreWin32HandleInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkImportSemaphoreWin32HandleKHX(dump_inst, result, device, pImportSemaphoreWin32HandleInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
inline void dump_vkGetSemaphoreWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetSemaphoreWin32HandleKHX(dump_inst, result, device, semaphore, handleType, pHandle);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetSemaphoreWin32HandleKHX(dump_inst, result, device, semaphore, handleType, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
#endif // VK_USE_PLATFORM_XLIB_KHR
inline void dump_vkImportSemaphoreFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreFdInfoKHX* pImportSemaphoreFdInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkImportSemaphoreFdKHX(dump_inst, result, device, pImportSemaphoreFdInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkImportSemaphoreFdKHX(dump_inst, result, device, pImportSemaphoreFdInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetSemaphoreFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, int* pFd)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetSemaphoreFdKHX(dump_inst, result, device, semaphore, handleType, pFd);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetSemaphoreFdKHX(dump_inst, result, device, semaphore, handleType, pFd);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceExternalBufferPropertiesKHX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfoKHX* pExternalBufferInfo, VkExternalBufferPropertiesKHX* pExternalBufferProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceExternalBufferPropertiesKHX(dump_inst, physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPhysicalDeviceExternalBufferPropertiesKHX(dump_inst, physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdDebugMarkerBeginEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCmdDebugMarkerInsertEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfoKHX* pExternalSemaphoreInfo, VkExternalSemaphorePropertiesKHX* pExternalSemaphoreProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(dump_inst, physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(dump_inst, physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceExternalBufferPropertiesKHX(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfoKHX* pExternalBufferInfo, VkExternalBufferPropertiesKHX* pExternalBufferProperties)
{
    instance_dispatch_table(physicalDevice)->GetPhysicalDeviceExternalBufferPropertiesKHX(physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
    dump_vkGetPhysicalDeviceExternalBufferPropertiesKHX(ApiDumpInstance::current(), physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfoKHX* pExternalSemaphoreInfo, VkExternalSemaphorePropertiesKHX* pExternalSemaphoreProperties)
{
    instance_dispatch_table(physicalDevice)->GetPhysicalDeviceExternalSemaphorePropertiesKHX(physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
    dump_vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(ApiDumpInstance::current(), physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
}
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryWin32HandleKHX(VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    VkResult result = device_dispatch_table(device)->GetMemoryWin32HandleKHX(device, memory, handleType, pHandle);
    dump_vkGetMemoryWin32HandleKHX(ApiDumpInstance::current(), result, device, memory, handleType, pHandle);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryWin32HandlePropertiesKHX(VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHX* pMemoryWin32HandleProperties)
{
    VkResult result = device_dispatch_table(device)->GetMemoryWin32HandlePropertiesKHX(device, handleType, handle, pMemoryWin32HandleProperties);
    dump_vkGetMemoryWin32HandlePropertiesKHX(ApiDumpInstance::current(), result, device, handleType, handle, pMemoryWin32HandleProperties);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHX
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryFdKHX(VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int* pFd)
{
    VkResult result = device_dispatch_table(device)->GetMemoryFdKHX(device, memory, handleType, pFd);
    dump_vkGetMemoryFdKHX(ApiDumpInstance::current(), result, device, memory, handleType, pFd);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetMemoryFdPropertiesKHX(VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int fd, VkMemoryFdPropertiesKHX* pMemoryFdProperties)
{
    VkResult result = device_dispatch_table(device)->GetMemoryFdPropertiesKHX(device, handleType, fd, pMemoryFdProperties);
    dump_vkGetMemoryFdPropertiesKHX(ApiDumpInstance::current(), result, device, handleType, fd, pMemoryFdProperties);
    return result;
}
#if defined(VK_USE_PLATFORM_WIN32_KHX)
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkImportSemaphoreWin32HandleKHX(VkDevice device, const VkImportSemaphoreWin32HandleInfoKHX* pImportSemaphoreWin32HandleInfo)
{
    VkResult result = device_dispatch_table(device)->ImportSemaphoreWin32HandleKHX(device, pImportSemaphoreWin32HandleInfo);
    dump_vkImportSemaphoreWin32HandleKHX(ApiDumpInstance::current(), result, device, pImportSemaphoreWin32HandleInfo);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreWin32HandleKHX(VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    VkResult result = device_dispatch_table(device)->GetSemaphoreWin32HandleKHX(device, semaphore, handleType, pHandle);
    dump_vkGetSemaphoreWin32HandleKHX(ApiDumpInstance::current(), result, device, semaphore, handleType, pHandle);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHX
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkImportSemaphoreFdKHX(VkDevice device, const VkImportSemaphoreFdInfoKHX* pImportSemaphoreFdInfo)
{
    VkResult result = device_dispatch_table(device)->ImportSemaphoreFdKHX(device, pImportSemaphoreFdInfo);
    dump_vkImportSemaphoreFdKHX(ApiDumpInstance::current(), result, device, pImportSemaphoreFdInfo);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetSemaphoreFdKHX(VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, int* pFd)
{
    VkResult result = device_dispatch_table(device)->GetSemaphoreFdKHX(device, semaphore, handleType, pFd);
    dump_vkGetSemaphoreFdKHX(ApiDumpInstance::current(), result, device, semaphore, handleType, pFd);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetInstanceProcAddr(VkInstance instance, const char* pName)
{
    ...
    if(strcmp(pName, "vkGetPhysicalDeviceExternalBufferPropertiesKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetPhysicalDeviceExternalBufferPropertiesKHX);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    ...
    if(strcmp(pName, "vkGetPhysicalDeviceExternalSemaphorePropertiesKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetPhysicalDeviceExternalSemaphorePropertiesKHX);
...
VK_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetDeviceProcAddr(VkDevice device, const char* pName)
{
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
    if(strcmp(pName, "vkGetMemoryWin32HandleKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetMemoryWin32HandleKHX);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
    if(strcmp(pName, "vkGetMemoryWin32HandlePropertiesKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetMemoryWin32HandlePropertiesKHX);
#endif // VK_USE_PLATFORM_WIN32_KHX
    ...
    if(strcmp(pName, "vkGetMemoryFdKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetMemoryFdKHX);
    ...
    if(strcmp(pName, "vkGetMemoryFdPropertiesKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetMemoryFdPropertiesKHX);
    if(strcmp(pName, "vkGetDeviceQueue") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetDeviceQueue);
#if defined(VK_USE_PLATFORM_WIN32_KHX)
    if(strcmp(pName, "vkImportSemaphoreWin32HandleKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkImportSemaphoreWin32HandleKHX);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
    if(strcmp(pName, "vkGetSemaphoreWin32HandleKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetSemaphoreWin32HandleKHX);
#endif // VK_USE_PLATFORM_WIN32_KHX
    ...
    if(strcmp(pName, "vkImportSemaphoreFdKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkImportSemaphoreFdKHX);
    ...
    if(strcmp(pName, "vkGetSemaphoreFdKHX") == 0)
        return reinterpret_cast<PFN_vkVoidFunction>(vkGetSemaphoreFdKHX);

...
std::ostream& dump_html_VkExternalMemoryImageCreateInfoKHX(const VkExternalMemoryImageCreateInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_html_VkWin32KeyedMutexAcquireReleaseInfoKHX(const VkWin32KeyedMutexAcquireReleaseInfoKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHR
...
std::ostream& dump_html_VkExternalMemoryBufferCreateInfoKHX(const VkExternalMemoryBufferCreateInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExportMemoryAllocateInfoKHX(const VkExportMemoryAllocateInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExportMemoryWin32HandleInfoKHX(const VkExportMemoryWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_VkImportMemoryWin32HandleInfoKHX(const VkImportMemoryWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_VkMemoryWin32HandlePropertiesKHX(const VkMemoryWin32HandlePropertiesKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
std::ostream& dump_html_VkPhysicalDeviceExternalSemaphoreInfoKHX(const VkPhysicalDeviceExternalSemaphoreInfoKHX& object, const ApiDumpSettings& settings, int indents);
std::ostream& dump_html_VkExternalSemaphorePropertiesKHX(const VkExternalSemaphorePropertiesKHX& object, const ApiDumpSettings& settings, int indents);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
std::ostream& dump_html_VkExportSemaphoreCreateInfoKHX(const VkExportSemaphoreCreateInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkMemoryFdPropertiesKHX(const VkMemoryFdPropertiesKHX& object, const ApiDumpSettings& settings, int indents);
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_VkImportSemaphoreWin32HandleInfoKHX(const VkImportSemaphoreWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_VkExportSemaphoreWin32HandleInfoKHX(const VkExportSemaphoreWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
std::ostream& dump_html_VkImportMemoryFdInfoKHX(const VkImportMemoryFdInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkCommandBufferBeginInfo(const VkCommandBufferBeginInfo& object, const ApiDumpSettings& settings, int indents);
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_VkD3D12FenceSubmitInfoKHX(const VkD3D12FenceSubmitInfoKHX& object, const ApiDumpSettings& settings, int indents);
#endif // VK_USE_PLATFORM_WIN32_KHX
...
std::ostream& dump_html_VkPipelineViewportStateCreateInfo(const VkPipelineViewportStateCreateInfo& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkImportSemaphoreFdInfoKHX(const VkImportSemaphoreFdInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExternalMemoryPropertiesKHX(const VkExternalMemoryPropertiesKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPhysicalDeviceExternalImageFormatInfoKHX(const VkPhysicalDeviceExternalImageFormatInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExternalImageFormatPropertiesKHX(const VkExternalImageFormatPropertiesKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPhysicalDeviceExternalBufferInfoKHX(const VkPhysicalDeviceExternalBufferInfoKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExternalBufferPropertiesKHX(const VkExternalBufferPropertiesKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkPhysicalDeviceIDPropertiesKHX(const VkPhysicalDeviceIDPropertiesKHX& object, const ApiDumpSettings& settings, int indents);
...
std::ostream& dump_html_VkExternalMemoryFeatureFlagBitsKHX(VkExternalMemoryFeatureFlagBitsKHX object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    bool is_first = true;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_DEDICATED_ONLY_BIT_KHX", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_EXPORTABLE_BIT_KHX", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_FEATURE_IMPORTABLE_BIT_KHX", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkExternalMemoryHandleTypeFlagBitsKHX(VkExternalMemoryHandleTypeFlagBitsKHX object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    bool is_first = true;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHX", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX", settings.stream(), is_first);
    if(object & 8)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHX", settings.stream(), is_first);
    if(object & 16)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHX", settings.stream(), is_first);
    if(object & 32)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHX", settings.stream(), is_first);
    if(object & 64)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHX", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkExternalSemaphoreHandleTypeFlagBitsKHX(VkExternalSemaphoreHandleTypeFlagBitsKHX object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    bool is_first = true;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_BIT_KHX", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHX", settings.stream(), is_first);
    if(object & 4)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHX", settings.stream(), is_first);
    if(object & 8)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D12_FENCE_BIT_KHX", settings.stream(), is_first);
    if(object & 16)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_FENCE_FD_BIT_KHX", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
std::ostream& dump_html_VkExternalSemaphoreFeatureFlagBitsKHX(VkExternalSemaphoreFeatureFlagBitsKHX object, const ApiDumpSettings& settings, int indents)
{
    settings.stream() << "<div class='val'>";
    bool is_first = true;
    settings.stream() << object;
    if(object & 1)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_FEATURE_EXPORTABLE_BIT_KHX", settings.stream(), is_first);
    if(object & 2)
        is_first = dump_html_bitmaskOption("VK_EXTERNAL_SEMAPHORE_FEATURE_IMPORTABLE_BIT_KHX", settings.stream(), is_first);
    if(!is_first)
        settings.stream() << ")";
    return settings.stream() << "</div></summary>";
}
...
inline std::ostream& dump_html_VkExternalSemaphoreHandleTypeFlagsKHX(VkExternalSemaphoreHandleTypeFlagsKHX object, const ApiDumpSettings& settings, int indents)
{
    return dump_html_VkExternalSemaphoreHandleTypeFlagBitsKHX((VkExternalSemaphoreHandleTypeFlagBitsKHX) object, settings, indents);
}
...
inline std::ostream& dump_html_VkExternalSemaphoreFeatureFlagsKHX(VkExternalSemaphoreFeatureFlagsKHX object, const ApiDumpSettings& settings, int indents)
{
    return dump_html_VkExternalSemaphoreFeatureFlagBitsKHX((VkExternalSemaphoreFeatureFlagBitsKHX) object, settings, indents);
}
...
inline std::ostream& dump_html_VkExternalMemoryHandleTypeFlagsKHX(VkExternalMemoryHandleTypeFlagsKHX object, const ApiDumpSettings& settings, int indents)
{
    return dump_html_VkExternalMemoryHandleTypeFlagBitsKHX((VkExternalMemoryHandleTypeFlagBitsKHX) object, settings, indents);
}
...
inline std::ostream& dump_html_VkExternalMemoryFeatureFlagsKHX(VkExternalMemoryFeatureFlagsKHX object, const ApiDumpSettings& settings, int indents)
{
    return dump_html_VkExternalMemoryFeatureFlagBitsKHX((VkExternalMemoryFeatureFlagBitsKHX) object, settings, indents);
}
...
std::ostream& dump_html_VkExternalMemoryImageCreateInfoKHX(const VkExternalMemoryImageCreateInfoKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalMemoryHandleTypeFlagsKHX>(object.handleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHX", "handleTypes", indents + 1, dump_html_VkExternalMemoryHandleTypeFlagsKHX);
    return settings.stream();
}
std::ostream& dump_html_VkBufferCreateInfo(const VkBufferCreateInfo& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkImportMemoryWin32HandleInfoKHX(const VkImportMemoryWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalMemoryHandleTypeFlagBitsKHX>(object.handleType, settings, "VkExternalMemoryHandleTypeFlagBitsKHX", "handleType", indents + 1, dump_html_VkExternalMemoryHandleTypeFlagBitsKHX);
...
std::ostream& dump_html_VkPhysicalDeviceExternalSemaphoreInfoKHX(const VkPhysicalDeviceExternalSemaphoreInfoKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalSemaphoreHandleTypeFlagBitsKHX>(object.handleType, settings, "VkExternalSemaphoreHandleTypeFlagBitsKHX", "handleType", indents + 1, dump_html_VkExternalSemaphoreHandleTypeFlagBitsKHX);
    return settings.stream();
}
std::ostream& dump_html_VkExternalSemaphorePropertiesKHX(const VkExternalSemaphorePropertiesKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalSemaphoreHandleTypeFlagsKHX>(object.exportFromImportedHandleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHX", "exportFromImportedHandleTypes", indents + 1, dump_html_VkExternalSemaphoreHandleTypeFlagsKHX);
    dump_html_value<const VkExternalSemaphoreHandleTypeFlagsKHX>(object.compatibleHandleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHX", "compatibleHandleTypes", indents + 1, dump_html_VkExternalSemaphoreHandleTypeFlagsKHX);
    dump_html_value<const VkExternalSemaphoreFeatureFlagsKHX>(object.externalSemaphoreFeatures, settings, "VkExternalSemaphoreFeatureFlagsKHX", "externalSemaphoreFeatures", indents + 1, dump_html_VkExternalSemaphoreFeatureFlagsKHX);
    return settings.stream();
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
std::ostream& dump_html_VkImportMemoryWin32HandleInfoNV(const VkImportMemoryWin32HandleInfoNV& object, const ApiDumpSettings& settings, int indents)
...
std::ostream& dump_html_VkExportSemaphoreCreateInfoKHX(const VkExportSemaphoreCreateInfoKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "const void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalSemaphoreHandleTypeFlagsKHX>(object.handleTypes, settings, "VkExternalSemaphoreHandleTypeFlagsKHX", "handleTypes", indents + 1, dump_html_VkExternalSemaphoreHandleTypeFlagsKHX);
    return settings.stream();
}
std::ostream& dump_html_VkImageViewCreateInfo(const VkImageViewCreateInfo& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkImportSemaphoreWin32HandleInfoKHX(const VkImportSemaphoreWin32HandleInfoKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkExternalSemaphoreHandleTypeFlagsKHX>(object.handleType, settings, "VkExternalSemaphoreHandleTypeFlagsKHX", "handleType", indents + 1, dump_html_VkExternalSemaphoreHandleTypeFlagsKHX);
    dump_html_value<const HANDLE>(object.handle, settings, "HANDLE", "handle", indents + 1, dump_html_HANDLE);
    return settings.stream();
}
#endif // VK_USE_PLATFORM_WIN32_KHX
...
std::ostream& dump_html_VkExternalMemoryPropertiesKHX(const VkExternalMemoryPropertiesKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    if(settings.showAddress())
        ...
        settings.stream() << "address\n";
    settings.stream() << "</div></summary>";
    dump_html_value<const VkExternalMemoryFeatureFlagsKHX>(object.externalMemoryFeatures, settings, "VkExternalMemoryFeatureFlagsKHX", "externalMemoryFeatures", indents + 1, dump_html_VkExternalMemoryFeatureFlagsKHX);
    dump_html_value<const VkExternalMemoryHandleTypeFlagsKHX>(object.exportFromImportedHandleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHX", "exportFromImportedHandleTypes", indents + 1, dump_html_VkExternalMemoryHandleTypeFlagsKHX);
    dump_html_value<const VkExternalMemoryHandleTypeFlagsKHX>(object.compatibleHandleTypes, settings, "VkExternalMemoryHandleTypeFlagsKHX", "compatibleHandleTypes", indents + 1, dump_html_VkExternalMemoryHandleTypeFlagsKHX);
    return settings.stream();
}
std::ostream& dump_html_VkCmdProcessCommandsInfoNVX(const VkCmdProcessCommandsInfoNVX& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkExternalImageFormatPropertiesKHX(const VkExternalImageFormatPropertiesKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_value<const VkStructureType>(object.sType, settings, "VkStructureType", "sType", indents + 1, dump_html_VkStructureType);
    dump_html_value<const void*>(object.pNext, settings, "void*", "pNext", indents + 1, dump_html_void);
    dump_html_value<const VkExternalMemoryPropertiesKHX>(object.externalMemoryProperties, settings, "VkExternalMemoryPropertiesKHX", "externalMemoryProperties", indents + 1, dump_html_VkExternalMemoryPropertiesKHX);
    return settings.stream();
}
std::ostream& dump_html_VkCmdReserveSpaceForCommandsInfoNVX(const VkCmdReserveSpaceForCommandsInfoNVX& object, const ApiDumpSettings& settings, int indents)
{
...
std::ostream& dump_html_VkPhysicalDeviceIDPropertiesKHX(const VkPhysicalDeviceIDPropertiesKHX& object, const ApiDumpSettings& settings, int indents)
{
    ...
    dump_html_array<const uint8_t>(object.deviceLUID, 8, settings, "uint8_t[VK_LUID_SIZE_KHX]", "uint8_t", "deviceLUID", indents + 1, dump_html_uint8_t);
...
std::ostream& dump_html_vkDebugMarkerSetObjectTagEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDebugMarkerObjectTagInfoEXT* pTagInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_pointer<const VkDebugMarkerObjectTagInfoEXT>(pTagInfo, settings, "VkDebugMarkerObjectTagInfoEXT*", "pTagInfo", 1, dump_html_VkDebugMarkerObjectTagInfoEXT);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";

    return settings.stream() << "</details>";
}
std::ostream& dump_html_vkGetMemoryFdPropertiesKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int fd, VkMemoryFdPropertiesKHX* pMemoryFdProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetMemoryFdPropertiesKHX(device, handleType, fd, pMemoryFdProperties)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_value<const VkExternalMemoryHandleTypeFlagBitsKHX>(handleType, settings, "VkExternalMemoryHandleTypeFlagBitsKHX", "handleType", 1, dump_html_VkExternalMemoryHandleTypeFlagBitsKHX);
        dump_html_value<const int>(fd, settings, "int", "fd", 1, dump_html_int);
        dump_html_pointer<const VkMemoryFdPropertiesKHX>(pMemoryFdProperties, settings, "VkMemoryFdPropertiesKHX*", "pMemoryFdProperties", 1, dump_html_VkMemoryFdPropertiesKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkDebugMarkerSetObjectNameEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDebugMarkerObjectNameInfoEXT* pNameInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_pointer<const VkDebugMarkerObjectNameInfoEXT>(pNameInfo, settings, "VkDebugMarkerObjectNameInfoEXT*", "pNameInfo", 1, dump_html_VkDebugMarkerObjectNameInfoEXT);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_vkGetMemoryWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetMemoryWin32HandleKHX(device, memory, handleType, pHandle)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_vkGetMemoryWin32HandlePropertiesKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBitsKHX handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHX* pMemoryWin32HandleProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetMemoryWin32HandlePropertiesKHX(device, handleType, handle, pMemoryWin32HandleProperties)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
    ...
    if(settings.showParams())
    {
        ...
        dump_html_pointer<const VkMemoryWin32HandlePropertiesKHX>(pMemoryWin32HandleProperties, settings, "VkMemoryWin32HandlePropertiesKHX*", "pMemoryWin32HandleProperties", 1, dump_html_VkMemoryWin32HandlePropertiesKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkGetMemoryFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsKHX handleType, int* pFd)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetMemoryFdKHX(device, memory, handleType, pFd)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_vkImportSemaphoreWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreWin32HandleInfoKHX* pImportSemaphoreWin32HandleInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkImportSemaphoreWin32HandleKHX(device, pImportSemaphoreWin32HandleInfo)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_pointer<const VkImportSemaphoreWin32HandleInfoKHX>(pImportSemaphoreWin32HandleInfo, settings, "const VkImportSemaphoreWin32HandleInfoKHX*", "pImportSemaphoreWin32HandleInfo", 1, dump_html_VkImportSemaphoreWin32HandleInfoKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
#if defined(VK_USE_PLATFORM_WIN32_KHX)
std::ostream& dump_html_vkGetSemaphoreWin32HandleKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, HANDLE* pHandle)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetSemaphoreWin32HandleKHX(device, semaphore, handleType, pHandle)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
    ...
    if(settings.showParams())
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_value<const VkSemaphore>(semaphore, settings, "VkSemaphore", "semaphore", 1, dump_html_VkSemaphore);
        dump_html_value<const VkExternalSemaphoreHandleTypeFlagBitsKHX>(handleType, settings, "VkExternalSemaphoreHandleTypeFlagBitsKHX", "handleType", 1, dump_html_VkExternalSemaphoreHandleTypeFlagBitsKHX);
        dump_html_pointer<const HANDLE>(pHandle, settings, "HANDLE*", "pHandle", 1, dump_html_HANDLE);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
#endif // VK_USE_PLATFORM_XLIB_KHR
std::ostream& dump_html_vkImportSemaphoreFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreFdInfoKHX* pImportSemaphoreFdInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkImportSemaphoreFdKHX(device, pImportSemaphoreFdInfo)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
    ...
    {
        dump_html_value<const VkDevice>(device, settings, "VkDevice", "device", 1, dump_html_VkDevice);
        dump_html_pointer<const VkImportSemaphoreFdInfoKHX>(pImportSemaphoreFdInfo, settings, "const VkImportSemaphoreFdInfoKHX*", "pImportSemaphoreFdInfo", 1, dump_html_VkImportSemaphoreFdInfoKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkGetSemaphoreFdKHX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSemaphore semaphore, VkExternalSemaphoreHandleTypeFlagBitsKHX handleType, int* pFd)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetSemaphoreFdKHX(device, semaphore, handleType, pFd)", "VkResult");
    dump_html_VkResult(result, settings, 0);
    settings.stream() << "</summary>";
...
std::ostream& dump_html_vkGetPhysicalDeviceWaylandPresentationSupportKHR(ApiDumpInstance& dump_inst, VkBool32 result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, struct wl_display* display)
{
    ...
    if(settings.showParams())
    {
        dump_html_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_html_VkPhysicalDevice);
        dump_html_value<const uint32_t>(queueFamilyIndex, settings, "uint32_t", "queueFamilyIndex", 1, dump_html_uint32_t);
        dump_html_pointer<const wl_display>(display, settings, "struct wl_display*", "display", 1, dump_html_wl_display);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkGetPhysicalDeviceExternalBufferPropertiesKHX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfoKHX* pExternalBufferInfo, VkExternalBufferPropertiesKHX* pExternalBufferProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetPhysicalDeviceExternalBufferPropertiesKHX(physicalDevice, pExternalBufferInfo, pExternalBufferProperties)", "void");
    settings.stream() << "</summary>";

    if(settings.showParams())
    {
        dump_html_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_html_VkPhysicalDevice);
        dump_html_pointer<const VkPhysicalDeviceExternalBufferInfoKHX>(pExternalBufferInfo, settings, "const VkPhysicalDeviceExternalBufferInfoKHX*", "pExternalBufferInfo", 1, dump_html_VkPhysicalDeviceExternalBufferInfoKHX);
        dump_html_pointer<const VkExternalBufferPropertiesKHX>(pExternalBufferProperties, settings, "VkExternalBufferPropertiesKHX*", "pExternalBufferProperties", 1, dump_html_VkExternalBufferPropertiesKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkCmdDebugMarkerBeginEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    {
        dump_html_value<const VkCommandBuffer>(commandBuffer, settings, "VkCommandBuffer", "commandBuffer", 1, dump_html_VkCommandBuffer);
        dump_html_pointer<const VkDebugMarkerMarkerInfoEXT>(pMarkerInfo, settings, "VkDebugMarkerMarkerInfoEXT*", "pMarkerInfo", 1, dump_html_VkDebugMarkerMarkerInfoEXT);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";
...
std::ostream& dump_html_vkCmdDebugMarkerInsertEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
...
std::ostream& dump_html_vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfoKHX* pExternalSemaphoreInfo, VkExternalSemaphorePropertiesKHX* pExternalSemaphoreProperties)
{
    const ApiDumpSettings& settings(dump_inst.settings());
    uint64_t current_frame = dump_inst.frameCount();
    if (current_frame == next_frame) {
    ...
    settings.stream() << "<div class='thd'>Thread " << dump_inst.threadID() << ":</div>";
    settings.stream() << "<details class='fn'><summary>";
    dump_html_nametype(settings.stream(), settings.showType(), "vkGetPhysicalDeviceExternalSemaphorePropertiesKHX(physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties)", "void");
    settings.stream() << "</summary>";

    if(settings.showParams())
    {
        dump_html_value<const VkPhysicalDevice>(physicalDevice, settings, "VkPhysicalDevice", "physicalDevice", 1, dump_html_VkPhysicalDevice);
        dump_html_pointer<const VkPhysicalDeviceExternalSemaphoreInfoKHX>(pExternalSemaphoreInfo, settings, "const VkPhysicalDeviceExternalSemaphoreInfoKHX*", "pExternalSemaphoreInfo", 1, dump_html_VkPhysicalDeviceExternalSemaphoreInfoKHX);
        dump_html_pointer<const VkExternalSemaphorePropertiesKHX>(pExternalSemaphoreProperties, settings, "VkExternalSemaphorePropertiesKHX*", "pExternalSemaphoreProperties", 1, dump_html_VkExternalSemaphorePropertiesKHX);
    }
    settings.shouldFlush() ? settings.stream() << std::endl : settings.stream() << "\n";

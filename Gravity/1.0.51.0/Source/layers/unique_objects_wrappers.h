    ...
    while (cur_pnext != NULL) {
        ...
        switch (header->sType) {
            ...
            case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHX: {
                    safe_VkWin32KeyedMutexAcquireReleaseInfoKHX *safe_struct = new safe_VkWin32KeyedMutexAcquireReleaseInfoKHX;
                    safe_struct->initialize(reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoKHX *>(cur_pnext));
                    if (safe_struct->pAcquireSyncs) {
                        for (uint32_t index0 = 0; index0 < safe_struct->acquireCount; ++index0) {
                            safe_struct->pAcquireSyncs[index0] = Unwrap(dev_data, safe_struct->pAcquireSyncs[index0]);
                        }
            ...
            case VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHX: {
                    safe_VkD3D12FenceSubmitInfoKHX *safe_struct = new safe_VkD3D12FenceSubmitInfoKHX;
                    safe_struct->initialize(reinterpret_cast<const VkD3D12FenceSubmitInfoKHX *>(cur_pnext));
                    cur_ext_struct = reinterpret_cast<void *>(safe_struct);
                } break;
    ...
    HANDLE*                                     pHandle)
{
    ...
    VkResult result = dev_data->dispatch_table.GetMemoryWin32HandleKHX(device, memory, handleType, pHandle);
    ...
    int*                                        pFd)
{
    ...
    VkResult result = dev_data->dispatch_table.GetMemoryFdKHX(device, memory, handleType, pFd);
    ...
    const VkImportSemaphoreWin32HandleInfoKHX*  pImportSemaphoreWin32HandleInfo)
{
    ...
    VkResult result = dev_data->dispatch_table.ImportSemaphoreWin32HandleKHX(device, (const VkImportSemaphoreWin32HandleInfoKHX*)local_pImportSemaphoreWin32HandleInfo);
    ...
    HANDLE*                                     pHandle)
{
    ...
    VkResult result = dev_data->dispatch_table.GetSemaphoreWin32HandleKHX(device, semaphore, handleType, pHandle);
    ...
    const VkImportSemaphoreFdInfoKHX*           pImportSemaphoreFdInfo)
{
    ...
    VkResult result = dev_data->dispatch_table.ImportSemaphoreFdKHX(device, (const VkImportSemaphoreFdInfoKHX*)local_pImportSemaphoreFdInfo);
    ...
    int*                                        pFd)
{
    ...
    VkResult result = dev_data->dispatch_table.GetSemaphoreFdKHX(device, semaphore, handleType, pFd);
